...
def main():
    ...
    parser.add_argument("--words-for-interruption", type=int, default=1)
    parser.add_argument("--interruption-backoff", type=int, default=50)
    parser.add_argument("--endpointing", type=int, default=400)
    parser.add_argument("--hangup-after-silence", type=int, default=13)
    parser.add_argument("--hangup-message", default="Bye!")
    parser.add_argument("--incremental-delay", type=int, default=500)
